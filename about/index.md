...
I've taught programming and data journalism workshops for a variety of organizations, including the [Investigative Reporters and Editors](http://ire.org), the [National Institute of Computer-Assisted Reporting](http://www.ire.org/nicar), [General Assemblyy](http://generalassemb.ly) in New York, the [International Journalism Festival](http://www.journalismfestival.com/), and the [Online News Association](http://journalists.org/).
